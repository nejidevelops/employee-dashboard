    ...
    <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500 pb-16 md:pb-0">
      ...
      <div className="bg-white rounded-2xl p-8 shadow-[0_4px_30px_rgba(21,25,108,0.05)] flex flex-col lg:flex-row items-center lg:items-end gap-8 relative overflow-hidden">
        ...
        <div className="flex-1 text-center lg:text-left z-10">
          <div className="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4 mb-2">
            <h2 className="text-3xl font-medium text-primary">Marcus Sterling</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 z-10 w-full lg:w-auto">
          <button className="bg-primary text-white px-6 py-3 rounded-xl font-medium flex items-center justify-center gap-2 hover:bg-primary/90 transition-all active:scale-95">
            <Star className="w-5 h-5 fill-current" /> Applaud Marcus
          </button>
          <button className="border-2 border-secondary text-secondary px-6 py-3 rounded-xl font-medium flex items-center justify-center gap-2 hover:bg-secondary/10 transition-all active:scale-95">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(21,25,108,0.05)]">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-2xl font-medium text-on-surface">Recognition History</h3>
            <span className="text-secondary text-xs font-medium cursor-pointer hover:underline">VIEW ALL</span>
          </div>
          ...
          <div className="space-y-8 relative">
              ...
              <div className="bg-white border border-slate-100 p-4 rounded-xl shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-medium text-primary">Sarah Jenkins</span>
                    <span className="text-slate-400 text-sm">• 2 days ago</span>
                  </div>
                  <span className="bg-green-100 text-green-700 text-xs font-medium px-2 py-0.5 rounded">+50 pts</span>
                </div>
                ...
                <div className="mt-3 flex gap-2">
                  <span className="px-2 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-medium rounded">#Excellence</span>
                  <span className="px-2 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-medium rounded">#Teamwork</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-12">
              ...
              <div className="bg-white border border-slate-100 p-4 rounded-xl shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-medium text-primary">Engineering Team</span>
                    <span className="text-slate-400 text-sm">• 1 week ago</span>
                  </div>
                  <span className="bg-green-100 text-green-700 text-xs font-medium px-2 py-0.5 rounded">+100 pts</span>
                </div>
                ...
                <div className="mt-3 flex gap-2">
                  <span className="px-2 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-medium rounded">#Efficiency</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-12">
              ...
              <div className="bg-white border border-slate-100 p-4 rounded-xl shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-medium text-primary">Dave Thompson</span>
                    <span className="text-slate-400 text-sm">• 2 weeks ago</span>
                  </div>
                  <span className="bg-green-100 text-green-700 text-xs font-medium px-2 py-0.5 rounded">+25 pts</span>
                </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-primary rounded-2xl p-6 text-white shadow-[0_4px_30px_rgba(21,25,108,0.05)] overflow-hidden relative">
            ...
            <h4 className="text-xs font-medium opacity-80 mb-4 tracking-widest">LIFETIME Zola</h4>
            ...
            <p className="text-xs mt-3 opacity-80">150 points until next rank: <span className="font-medium">Platinum Performer</span></p>
          </div>

          {/* Badges */}
          <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(21,25,108,0.05)]">
            <h3 className="text-xl font-medium text-on-surface mb-6">Earned Badges</h3>
            <div className="grid grid-cols-3 gap-4">
              <div className="flex flex-col items-center text-center group cursor-pointer">
                ...
                <span className="text-[10px] font-medium text-slate-500">Mentorship</span>
              </div>
              <div className="flex flex-col items-center text-center group cursor-pointer">
                <div className="w-14 h-14 rounded-full bg-indigo-50 flex items-center justify-center mb-2 group-hover:bg-primary transition-colors">
                  <Zap className="w-6 h-6 text-primary group-hover:text-white" />
                </div>
                <span className="text-[10px] font-medium text-slate-500">Fast Mover</span>
              </div>
              <div className="flex flex-col items-center text-center group cursor-pointer">
                <div className="w-14 h-14 rounded-full bg-indigo-50 flex items-center justify-center mb-2 group-hover:bg-primary transition-colors">
                  <Users className="w-6 h-6 text-primary group-hover:text-white" />
                </div>
                <span className="text-[10px] font-medium text-slate-500">Cultural Hub</span>
              </div>
              <div className="flex flex-col items-center text-center group cursor-pointer">
                <div className="w-14 h-14 rounded-full bg-indigo-50 flex items-center justify-center mb-2 group-hover:bg-primary transition-colors">
                  <CheckCircle className="w-6 h-6 text-primary group-hover:text-white" />
                </div>
                <span className="text-[10px] font-medium text-slate-500">Top Rated</span>
              </div>
              <div className="flex flex-col items-center text-center group cursor-pointer">
                <div className="w-14 h-14 rounded-full bg-indigo-50 flex items-center justify-center mb-2 group-hover:bg-primary transition-colors">
                  <Rocket className="w-6 h-6 text-primary group-hover:text-white" />
                </div>
                <span className="text-[10px] font-medium text-slate-500">Innovator</span>
              </div>
          ...
          {/* Skills & Expertise */}
          <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(21,25,108,0.05)]">
            <h3 className="text-xl font-medium text-on-surface mb-6">Expertise</h3>
            <div className="flex flex-wrap gap-2">
              {['Product Strategy', 'UX Design', 'Prototyping', 'Design Systems', 'User Research', 'A/B Testing', 'Micro-interactions'].map(skill => (
                <span key={skill} className="px-4 py-2 bg-slate-100 text-primary text-sm font-normal rounded-lg">
                  {skill}
                </span>
              ))}
            </div>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-[0_4px_30px_rgba(21,25,108,0.05)]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-medium text-on-surface mb-4">Collaborators</h3>
            ...
            <div className="flex -space-x-4 mb-4">
              ...
              <div className="w-14 h-14 rounded-full border-4 border-white shadow-sm bg-slate-100 flex items-center justify-center text-primary font-medium hover:z-10 transition-transform cursor-pointer">+12</div>
            </div>
          </div>
          ...
          <div className="bg-indigo-50/50 rounded-xl p-6 relative">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h4 className="font-medium text-primary">Momentum</h4>
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
              <div className="text-center">
                ...
                <div className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Streaks</div>
              </div>
              <div className="w-px h-10 bg-slate-100"></div>
              <div className="text-center">
                <div className="text-2xl font-black text-primary">4.9</div>
                <div className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Rating</div>
              </div>
              <div className="w-px h-10 bg-slate-100"></div>
              <div className="text-center">
                <div className="text-2xl font-black text-primary">85%</div>
                <div className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Growth</div>
              </div>
            </div>
          </div>
        </div>
