      ...
      <div className="flex-1 flex flex-col overflow-hidden border-r border-slate-200">
        ...
        <div className="px-6 pt-6 pb-4">
          <div className="flex items-center gap-2 text-primary mb-6">
            ...
            <h1 className="text-2xl font-medium">Scorecards</h1>
          </div>
          
          <div className="flex border-b border-slate-200 mb-6">
            <button className="px-4 py-2 border-b-2 border-secondary text-secondary font-medium text-sm">Scores</button>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            <div className="inline-flex p-1 bg-surface-container-low rounded-lg">
              <button className="flex items-center gap-2 px-6 py-2 bg-white rounded-md shadow-sm text-sm font-medium text-primary">
          ...
          <div className="flex gap-2 mb-4">
            ...
            <div className="flex gap-2">
              <div className="flex items-center border border-slate-200 rounded-lg px-3 bg-white">
                ...
                <select className="border-none p-0 text-sm font-medium text-primary focus:ring-0 focus:outline-none bg-transparent">
                  <option>All</option>
                </select>
              </div>
              <button className="flex items-center gap-2 px-4 py-2 border border-slate-200 rounded-lg text-sm font-medium text-primary hover:bg-slate-50">
        ...
        <div className="flex-1 overflow-auto">
          <table className="w-full text-left border-collapse">
            <thead className="sticky top-0 bg-white z-10 border-y border-slate-200">
              <tr className="text-[11px] uppercase tracking-wider text-outline font-medium">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              <tr className="bg-indigo-50/30">
                <td className="px-6 py-3 flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-secondary">Mark Hart</span>
                </td>
                <td className="px-6 py-3 text-sm font-normal text-primary">77/80</td>
                <td className="px-6 py-3 text-sm font-normal text-primary">10/14</td>
              ...
              <tr className="hover:bg-slate-50 cursor-pointer">
                <td className="px-6 py-3 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-xs font-medium text-indigo-600">TD</div>
              ...
              <tr className="hover:bg-slate-50 cursor-pointer">
                ...
                <td className="px-6 py-3 text-sm font-normal text-green-600 bg-green-50/50">98/80</td>
      ...
      <aside className="w-80 flex-shrink-0 flex flex-col bg-white overflow-y-auto border-l border-slate-200">
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <button className="flex items-center text-sm font-normal text-secondary hover:underline">
          ...
          <div className="text-center mb-8">
            ...
            <div className="mx-auto relative inline-flex flex-col items-center justify-center p-8 bg-green-50/50 rounded-full border-2 border-green-200/50 w-40 h-40">
              <p className="text-[10px] text-green-600 font-medium uppercase tracking-widest mb-1">Expectation 14</p>
              <p className="text-5xl font-black text-green-700">92</p>
              <p className="text-[10px] text-outline font-normal mt-1">User score</p>
            </div>
            <p className="text-[11px] text-outline font-normal mt-4">Bonus for reaching expectation: $15.00</p>
          ...
          <div className="space-y-4 mb-8">
            {['Harsh braking', 'Idle time', 'Seat belt usage', 'Harsh cornering', 'Harsh acceleration'].map((metric) => (
              <div key={metric} className="flex items-center justify-between group cursor-help">
                ...
                <span className="text-[11px] text-outline font-normal">(20% of score)</span>
              </div>
            ))}
          </div>
          ...
          <div className="bg-surface-container-low p-4 rounded-xl border border-indigo-50">
            <h4 className="text-sm font-medium text-primary mb-2">What is Driver Safety Score?</h4>
            ...
            <h4 className="text-sm font-medium text-primary mb-2">How it is calculated</h4>
